...
var First3FollowersComponent = (function (_React$Component) {
    _inherits(First3FollowersComponent, _React$Component);

    function First3FollowersComponent() {
        _classCallCheck(this, First3FollowersComponent);

        _get(Object.getPrototypeOf(First3FollowersComponent.prototype), 'constructor', this).call(this);
        this.state = {
    ...
    _createClass(First3FollowersComponent, [{
    ...
    return First3FollowersComponent;
})(React.Component);
