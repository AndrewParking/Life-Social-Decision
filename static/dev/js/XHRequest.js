...
module.exports = {
    ...
    _send_message_xhr(toAccountId, content) {
        return new Promise(function (resolve, reject) {
            var request = new XMLHttpRequest(),
