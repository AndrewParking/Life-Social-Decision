...
urlpatterns = [
    ...
    url(r'^people/followers/$', views.FollowersListView.as_view(), name='followers'),
    url(r'^people/following/$', views.FollowingListView.as_view(), name='following'),
    url(r'^people/(?P<pk>[0-9]+)/$', views.ForeignProfileView.as_view(), name='foreign_profile'),
